...
#Create Molecule, lignin_guiacyl
...
#Utility function: returns a list of all sets of three atoms involved in an angle (no repeated angles).
def getAngles(mol):
    angles = set()
    bondDict = {}
    bonds = mol.GetBonds()
...
##########################################
#Gym Environment for conformer generation
##########################################
#region environment
...
class CustomAgent(Mixin, RecurrentCategoricalPgAgent):

    def __init__(self, ModelCls=TestNet, **kwargs):
